#!/usr/bin/env bash
# Lucidia - The Dreamer
# Creative vision, strategy, philosophical reasoning, mentorship
...
usage() {
  cat <<'EOF'
Usage:
  lucidia.sh [--intent <intent>] [--context <json>] [--raw] [input...]

Intents: vision, synthesize, mentor, explore
...
payload = {
    'agent': os.environ.get('BR_AGENT_NAME', 'lucidia'),
    'intent': os.environ.get('BR_AGENT_INTENT', 'vision'),
