...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/roadgateway.git
cd roadgateway

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/roadgateway.git
