#!/usr/bin/env bash
# Prism - The Analyst
# Pattern recognition, data analysis, metrics, observability
...
usage() {
  cat <<'EOF'
Usage:
  prism.sh [--intent <intent>] [--context <json>] [--raw] [input...]

Intents: analyze, correlate, report, forecast
...
payload = {
    'agent': os.environ.get('BR_AGENT_NAME', 'prism'),
