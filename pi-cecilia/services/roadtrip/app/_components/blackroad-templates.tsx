...
export function AppRuntimeTemplate({
  hero,
  stats,
  lanes,
  topics,
  ...
  return (
    <main>
      ...
      />
      <StatGrid items={stats} />
      {detailTitle && detailDescription && detailContent ? (
        <>
          <SectionHeader
            number='03 — Runtime Detail'
            title={detailTitle}
      ...
      <SectionHeader
        number={detailTitle && detailDescription && detailContent ? '04 — Active Lanes' : '03 — Active Lanes'}
