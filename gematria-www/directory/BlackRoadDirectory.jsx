...
export default function BlackRoadDirectory(){
  const w=useWidth();
  return(<>
    <style>{`
    ...
    <div style={{background:"#000",minHeight:"100vh",color:"#f0f0f0",overflowX:"hidden",width:"100%"}}>
      ...
      <section style={{minHeight:"60vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:w<480?"120px 20px 60px":"140px 40px 80px",textAlign:"center",position:"relative"}}>
        ...
        <h1 style={{fontFamily:grotesk,fontWeight:700,fontSize:"clamp(36px,10vw,72px)",color:"#f5f5f5",letterSpacing:"-0.04em",lineHeight:0.95,marginBottom:24,animation:"fadeUp 0.6s ease 0.2s both"}}>Directory</h1>
        <p style={{fontFamily:inter,fontSize:"clamp(15px,3vw,18px)",color:"#606060",lineHeight:1.7,maxWidth:520,animation:"fadeUp 0.6s ease 0.3s both"}}>Every domain, org, and service in one place.</p>
          ...
          <div style={{display:"grid",gridTemplateColumns:w>=900?"repeat(3,1fr)":w>=580?"repeat(2,1fr)":"1fr",gap:8}}>
            <FadeIn delay={0}>
              <div style={{background:"#080808",border:"1px solid #141414",padding:"28px 24px",height:"100%"}}>
                ...
                <div style={{fontFamily:grotesk,fontWeight:700,fontSize:18,color:"#ebebeb",marginBottom:10}}>20 Domains</div>
                <div style={{fontFamily:inter,fontSize:14,color:"#545454",lineHeight:1.7}}>blackroad.io and 19 more.</div>
              </div>
            </FadeIn>
            <FadeIn delay={70}>
              <div style={{background:"#080808",border:"1px solid #141414",padding:"28px 24px",height:"100%"}}>
                <div style={{height:2,width:32,background:STOPS[1],marginBottom:18}}/>
                <div style={{fontFamily:grotesk,fontWeight:700,fontSize:18,color:"#ebebeb",marginBottom:10}}>15 Organizations</div>
                <div style={{fontFamily:inter,fontSize:14,color:"#545454",lineHeight:1.7}}>Core, AI, Enterprise, and more.</div>
              </div>
            </FadeIn>
            <FadeIn delay={140}>
              <div style={{background:"#080808",border:"1px solid #141414",padding:"28px 24px",height:"100%"}}>
                <div style={{height:2,width:32,background:STOPS[2],marginBottom:18}}/>
                <div style={{fontFamily:grotesk,fontWeight:700,fontSize:18,color:"#ebebeb",marginBottom:10}}>95+ Pages</div>
                <div style={{fontFamily:inter,fontSize:14,color:"#545454",lineHeight:1.7}}>Every website deployed.</div>
              </div>
            </FadeIn>
            <FadeIn delay={210}>
              <div style={{background:"#080808",border:"1px solid #141414",padding:"28px 24px",height:"100%"}}>
                <div style={{height:2,width:32,background:STOPS[3],marginBottom:18}}/>
                <div style={{fontFamily:grotesk,fontWeight:700,fontSize:18,color:"#ebebeb",marginBottom:10}}>275+ Repositories</div>
                <div style={{fontFamily:inter,fontSize:14,color:"#545454",lineHeight:1.7}}>Gitea primary, GitHub mirror.</div>
              </div>
            </FadeIn>
          </div>
        </div>
