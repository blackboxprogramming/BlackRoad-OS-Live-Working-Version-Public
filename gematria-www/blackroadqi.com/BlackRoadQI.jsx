...
export default function BlackRoadQI(){
  const w=useWidth();
  return(<>
    <style>{`
    ...
    <div style={{background:"#000",minHeight:"100vh",color:"#f0f0f0",overflowX:"hidden",width:"100%"}}>
      ...
      <section style={{minHeight:"60vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:w<480?"120px 20px 60px":"140px 40px 80px",textAlign:"center",position:"relative"}}>
        ...
        <h1 style={{fontFamily:grotesk,fontWeight:700,fontSize:"clamp(36px,10vw,72px)",color:"#f5f5f5",letterSpacing:"-0.04em",lineHeight:0.95,marginBottom:24,animation:"fadeUp 0.6s ease 0.2s both"}}>BlackRoad QI</h1>
        <p style={{fontFamily:inter,fontSize:"clamp(15px,3vw,18px)",color:"#606060",lineHeight:1.7,maxWidth:520,animation:"fadeUp 0.6s ease 0.3s both"}}>Quantum Intelligence. Where quantum math meets sovereign AI.</p>
