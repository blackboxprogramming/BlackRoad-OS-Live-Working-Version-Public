  ...
  return(<>
    ...
    <div style={{background:"#000",minHeight:"100vh",color:"#f0f0f0",overflowX:"hidden",width:"100%"}}>
      ...
      <section style={{minHeight:"80vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:w<480?"120px 20px 60px":"140px 40px 80px",textAlign:"center",position:"relative"}}>
        ...
        <h1 style={{fontFamily:grotesk,fontWeight:700,fontSize:"clamp(48px,12vw,96px)",color:"#f5f5f5",letterSpacing:"-0.04em",lineHeight:0.95,marginBottom:16,animation:"fadeUp 0.6s ease 0.2s both"}}>Atlas</h1>
        <p style={{fontFamily:inter,fontSize:"clamp(15px,3vw,18px)",color:"#606060",lineHeight:1.7,maxWidth:520,marginBottom:24,animation:"fadeUp 0.6s ease 0.3s both"}}>Topology mapper, mesh architect, routing oracle. Knows where everything is.</p>
        <div style={{fontFamily:mono,fontSize:13,color:"#333",animation:"fadeUp 0.6s ease 0.4s both"}}>atlas@blackroad.io</div>
