...
| 2026-04-24 | `blackroad.io/home/` | Switched to registry-backed branding + unified `/api/*` routes across root domains | `/Applications/BlackRoad/BlackRoadOS/workspace/hardening/2026-04-24/screenshots/blackroad.io-home-playwright.png` | no | Playwright headless is still blocked by Cloudflare (“Sorry, you have been blocked”). OS-level screenshot helper (`ensure_macos_permissions.sh`) failed due to Swift toolchain mismatch; manual in-browser QA still required. |
